package com.luomo.study.design.patten.decorator;
...
public class IOTest {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //文件路径可自行更换
        final String filePath = "F:\\idea_workspace\\design-mode\\src\\main\\java\\com\\luomo\\study\\design\\patten\\decorator\\test.txt";
