...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        menu.put("雪碧", 5);
        //假设有5个分店
        Subbranch mcSubbranch1 = new McSubbranch(0, 0, new HashMap<>(menu));
        Subbranch mcSubbranch2 = new McSubbranch(100, 120, new HashMap<>(menu));
        Subbranch mcSubbranch3 = new McSubbranch(-100, -120, new HashMap<>(menu));
        Subbranch mcSubbranch4 = new McSubbranch(1000, 20, new HashMap<>(menu));
        Subbranch mcSubbranch5 = new McSubbranch(-500, 0, new HashMap<>(menu));
